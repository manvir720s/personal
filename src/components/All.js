    ...
    render() {
	    return (
            <body data-spy="scroll" data-target="#pb-navbar" data-offset="200">
                ...
                <section class="site-hero" style={{backgroundImage: 'url(images/image_1.jpg)'}} id="section-home" data-stellar-background-ratio="0.5">
                    <div class="container">
                                        ...
                                        <a href="images/p1.jpg" class="img-pop-up">  
                                            <div class="middle">
                                                <div class="text align-self-center d-flex">
                                                    <img src="images/preview.png" alt=""/></div>
                                            </div>
                                        </a>                                  
                                    </div>
                                    <div class="p-inner">
                        ...
                        <div class="container">
                            <div class="row mb-5 align-items-center">
                                <div class="col-lg-7 pr-lg-5 mb-5 mb-lg-0">
                                    <img src="images/image_1.jpg" alt="Image placeholder" 
                                    class="img-fluid"/>
                                </div>
                                    ...
                                    <div class="col-md-7 mb-5 mb-md-0">
                                        <form action="" class="site-form">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control px-3 py-4" 
                                                placeholder="Your Name"/>
                                            </div>
                                            <div class="form-group">
                                                <input type="email" class="form-control px-3 py-4" 
